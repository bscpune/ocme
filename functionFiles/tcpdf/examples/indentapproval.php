...
$indent_code = $_GET['indent_code'];
 $query = "SELECT ih.indent_type,ih.indent_code,ih.indent_date,pr.project_name,act.activity_name,con.contractor_name,st.site_location,ih.remark,um.user_location from indent_head ih,tbl_project_master pr,tbl_activity_master act,tbl_site_master st,tbl_contractor_master con,tbl_user_master um where ih.project_id=pr.project_id and ih.site_id=st.site_id and ih.activity_id=act.activity_id and ih.contractor_id=con.contractor_id and ih.indent_code='".$indent_code."'";
    ...
    $query1="SELECT im.material_code,mm.material_name,ih.indent_code,
mm.material_description,mm.unit_of_measurment,im.indent_material_qty,im.approved_total_qty 
FROM indent_head as ih,indent_material as im,tbl_material_master as mm where ih.indent_id=im.indent_id and mm.material_id=im.material_id and ih.indent_code='".$indent_code."'";
...
<th align="left" style="width: 100px;"><b>INDENT APPROVAL/<br/>
RETURN CHALLAN</b></th>
...
<table class="table_data" border="1"  align="center" cellpadding="01">
<tr>
<th align="left" style="width: 220px;"><b>INDENT TYPE</b>:'.$json['indent_type'].'</th>
<th align="left" style="width: 150px;"><b>INDENT CODE</b>:'.$json['indent_code'].'</th>
</tr>

<tr>
<td align="left" style="width: 220px;"><b>INDENT DATE</b>: '.$json['indent_date'].'<br/><br/>
<b>PROJECT NAME</b>:   '.$json['project_name'].' <br/><br/>
<b>REMARK</b>:   '.$json['remark'].'</td>

<td align="left" style="width: 150px;"><b>ACTIVITY NAME</b>:   '.$json['activity_name'].'<br/><br/>
<b>CONTRACTOR NAME</b>:   '.$json['contractor_name'].'<br/><br/>
<b>SITE LOCATION</b>:   '.$json['site_location'].'</td>
</tr>
';
...
<th align="center" style="width: 60px;"><b>MATERIAL CODE</b></th>
<th align="center" style="width: 70px;"><b>MATERIAL NAME</b></th>
<th align="center" style="width: 70px;"><b>MATERIAL DESCRIPTION</b></th>
<th align="center" style="width: 40px;"><b>QUANTITY</b></th>
<th align="center" style="width: 40Px;"><b>UOM</b></th>
<th align="center" style="width: 50Px;"><b>APPROVED QUANTITY</b></th>
</tr>
';
...
for($i=0;$i<sizeof($json1);$i++){
  ...
  $approvedquantity = $approvedquantity + $json1[$i]['approved_total_qty'];
  ...
  <th align="center" style="width: 40px;">'.$json1[$i]['indent_material_qty'].'</th>
  <th align="center" style="width: 40px;">'.$json1[$i]['unit_of_measurment'].'</th>
  <th align="center" style="width: 50px;">'.$json1[$i]['approved_total_qty'].'</th>
  </tr>
  ';
}
